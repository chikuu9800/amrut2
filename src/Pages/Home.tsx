...
//     <Slider/>
//     <motion.div
//       className="flex flex-col md:flex-row justify-center items-start gap-8 p-6 min-h-screen bg-gray-50 "
...
//       >
//         <motion.div
//           className="overflow-y-auto h-[80vh] border rounded-lg shadow-md p-4 bg-white"
//           whileHover={{ boxShadow: "0px 0px 12px rgba(0,0,0,0.1)" }}
...
//                     className="pl-4 pb-2 bg-gray-50 text-sm text-gray-700 rounded"
//                   >
...
//                               className="w-full flex justify-between items-center py-1 font-medium text-blue-700"
//                             >
//                               {sub.title}
//                               <motion.div
//                                 animate={{
...
//                           </>
//                         ) : (
//                           <div className="pl-2 py-1 text-gray-700">{sub}</div>
//                         )}
//                       </div>
//                     ))}
//                   </motion.div>
...
//       {/* RIGHT SIDE - Static Options with Header */}
//       <motion.div
...
//               }}
//               whileTap={{ scale: 0.97 }}
//               className="mb-2 border-b py-2 font-semibold text-gray-800 cursor-pointer rounded px-2"
                        ...
                        {item.submenu.map((sub, subIndex) => (
                          <div key={subIndex} className="mb-1">
                            {typeof sub === "object" ? (
                              ...
                              <motion.div
                                className="pl-2 py-1 text-gray-700"
                                whileHover={{ x: 5 }}
                              >
                                {sub}
                              </motion.div>
